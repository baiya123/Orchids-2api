...
func (s *Store) seedModels() error {
	...
	models := []Model{
		...
		{ID: "42", Channel: "Orchids", ModelID: "claude-sonnet-4-5-thinking", Name: "Claude Sonnet 4.5 Thinking", Status: true, IsDefault: false, SortOrder: 2},
		...
		{ID: "8", Channel: "Orchids", ModelID: "claude-haiku-4-5", Name: "Claude Haiku 4.5", Status: true, IsDefault: false, SortOrder: 4},
		{ID: "9", Channel: "Orchids", ModelID: "claude-sonnet-4-20250514", Name: "Claude Sonnet 4", Status: true, IsDefault: false, SortOrder: 5},
		{ID: "10", Channel: "Orchids", ModelID: "claude-3-7-sonnet-20250219", Name: "Claude 3.7 Sonnet", Status: true, IsDefault: false, SortOrder: 6},
		// Warp 模型
		...
		{ID: "71", Channel: "Warp", ModelID: "claude-4-5-sonnet-thinking", Name: "Claude 4.5 Sonnet Thinking (Warp)", Status: true, IsDefault: false, SortOrder: 4},
		{ID: "64", Channel: "Warp", ModelID: "claude-4-5-opus", Name: "Claude 4.5 Opus (Warp)", Status: true, IsDefault: false, SortOrder: 5},
		{ID: "72", Channel: "Warp", ModelID: "claude-4-5-opus-thinking", Name: "Claude 4.5 Opus Thinking (Warp)", Status: true, IsDefault: false, SortOrder: 6},
		{ID: "73", Channel: "Warp", ModelID: "claude-4-6-opus-high", Name: "Claude 4.6 Opus High (Warp)", Status: true, IsDefault: false, SortOrder: 7},
		{ID: "74", Channel: "Warp", ModelID: "claude-4-6-opus-max", Name: "Claude 4.6 Opus Max (Warp)", Status: true, IsDefault: false, SortOrder: 8},
		{ID: "75", Channel: "Warp", ModelID: "claude-4-5-haiku", Name: "Claude 4.5 Haiku (Warp)", Status: true, IsDefault: false, SortOrder: 9},
		{ID: "76", Channel: "Warp", ModelID: "gemini-2-5-pro", Name: "Gemini 2.5 Pro (Warp)", Status: true, IsDefault: false, SortOrder: 10},
		{ID: "77", Channel: "Warp", ModelID: "gemini-3-pro", Name: "Gemini 3 Pro (Warp)", Status: true, IsDefault: false, SortOrder: 11},
		{ID: "65", Channel: "Warp", ModelID: "gpt-5-low", Name: "GPT-5 Low (Warp)", Status: true, IsDefault: false, SortOrder: 12},
		{ID: "78", Channel: "Warp", ModelID: "gpt-5-medium", Name: "GPT-5 Medium (Warp)", Status: true, IsDefault: false, SortOrder: 13},
		{ID: "79", Channel: "Warp", ModelID: "gpt-5-high", Name: "GPT-5 High (Warp)", Status: true, IsDefault: false, SortOrder: 14},
		{ID: "80", Channel: "Warp", ModelID: "gpt-5-1-low", Name: "GPT-5.1 Low (Warp)", Status: true, IsDefault: false, SortOrder: 15},
		{ID: "81", Channel: "Warp", ModelID: "gpt-5-1-medium", Name: "GPT-5.1 Medium (Warp)", Status: true, IsDefault: false, SortOrder: 16},
		{ID: "82", Channel: "Warp", ModelID: "gpt-5-1-high", Name: "GPT-5.1 High (Warp)", Status: true, IsDefault: false, SortOrder: 17},
		{ID: "83", Channel: "Warp", ModelID: "gpt-5-1-codex-low", Name: "GPT-5.1 Codex Low (Warp)", Status: true, IsDefault: false, SortOrder: 18},
		{ID: "84", Channel: "Warp", ModelID: "gpt-5-1-codex-medium", Name: "GPT-5.1 Codex Medium (Warp)", Status: true, IsDefault: false, SortOrder: 19},
		{ID: "85", Channel: "Warp", ModelID: "gpt-5-1-codex-high", Name: "GPT-5.1 Codex High (Warp)", Status: true, IsDefault: false, SortOrder: 20},
		{ID: "86", Channel: "Warp", ModelID: "gpt-5-1-codex-max-low", Name: "GPT-5.1 Codex Max Low (Warp)", Status: true, IsDefault: false, SortOrder: 21},
		{ID: "70", Channel: "Warp", ModelID: "warp-basic", Name: "Warp Basic", Status: true, IsDefault: false, SortOrder: 22},
	}
